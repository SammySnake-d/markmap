 ...
 *
 * 使用 Lucide Icons (https://lucide.dev) 替代 Emoji
 * 优点：
 * - 跨平台一致性
 * - 支持 currentColor 适配深色/浅色模式
 * - 可调整大小和粗细
 *
 * @file icons.ts
 */
...
/**
 * 图标 SVG 路径定义
 * 基于 Lucide Icons，24x24 视口，stroke-width: 2
 */
export const ICONS = {
  // 复制/剪贴板
 ...
 * @param name - 图标名称
 * @param size - 图标大小（默认 16）
 * @returns HTMLSpanElement 包含 SVG
 */
